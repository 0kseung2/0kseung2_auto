...
# bar_value = Reference(ws, min_row=2, max_row=11, min_col=2, max_col=3) #B2:C11가지의 데이터를 차트로 생성
...
line_value = Reference(ws, min_row=1, max_row=11, min_col=2, max_col=3) #B1:C11까지의 데이터
